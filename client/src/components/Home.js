    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item cta"><Link className = "nav-link" to = '/signin'>Sign in</Link></li>
          <li class="nav-item cta"><Link className = "nav-link" to = '/signup'>Sign Up</Link></li>
            ...
            <a href="#" class="featured-img">
              ...
              <div class="text p-4 d-flex align-items-center">
                <div class="user d-flex align-items-center">
                   <div className="user-img mr-3" style={{ backgroundImage: `url(${require('../images/person_1.jpg')})` }}></div>
    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <a href="portfolio.html" className="image" style={{ backgroundImage: `url(${require('../images/work-1.jpg')})`, transform: 'translateY(-20%)' }}/>
          ...
          <a href="portfolio.html" className="image" style={{ backgroundImage: `url(${require('../images/work-2.jpg')})`, transform: 'translateY(-20%)' }}/>            <div class="text order-1">
          ...
          <a href="portfolio.html" className="image" style={{ backgroundImage: `url(${require('../images/work-3.jpg')})`, transform: 'translateY(-20%)' }}/>            <div class="text">
          ...
          <div class="col-md-12">
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item text-center">
                ...
                <div className="user-img mb-4" style={{ backgroundImage: `url(${require('../images/person_1.jpg')})` }}>
              ...
              <div class="item text-center">
                <div class="testimony-wrap p-4 pb-5">
                <div className="user-img mb-4" style={{ backgroundImage: `url(${require('../images/person_2.jpg')})` }}>
                <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item text-center">
                <div class="testimony-wrap p-4 pb-5">
                <div className="user-img mb-4" style={{ backgroundImage: `url(${require('../images/person_3.jpg')})` }}>
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4 ftco-animate">
            ...
            <a href="blog-single.html" className="block-20" style={{ backgroundImage: `url(${require('../images/image_1.jpg')})` }}></a>
          ...
          <div class="col-md-4 ftco-animate">
            ...
            <a href="blog-single.html" className="block-20" style={{ backgroundImage: `url(${require('../images/image_2.jpg')})` }}></a>
